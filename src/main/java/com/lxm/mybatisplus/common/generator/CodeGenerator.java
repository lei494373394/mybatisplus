package com.lxm.mybatisplus.common.generator;
...
public class CodeGenerator {
    ...
    // @author 值
    private static final String AUTHOR = "lxm";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.lxm.mybatisplus";
    // xml文件路径
    ...
    public static void main(String[] args) {
        ...
        focList.add(new FileOutConfig(XML_MAPPER_TEMPLATE_PATH+".ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + XML_PACKAGE_URL + packageConfig.getModuleName()
    ...
    private static String scanner(String tip) {
        ...
        if (scanner.hasNext()) {
            ...
            if (StringUtils.isNoneBlank(ipt)) return ipt;
        }
